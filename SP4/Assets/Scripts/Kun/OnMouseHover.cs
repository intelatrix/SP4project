...
public class OnMouseHover : MonoBehaviour {
	...
	void OnMouseOver() {
		if (name == "dentist") {
			...
			content2.GetComponent<Text> ().text = "Pioneer Discount: " + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().eventDiscount [0].ToString () + "%";
			...
			content2.GetComponent<Text> ().text = "Pioneer Discount: " + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().eventDiscount [1].ToString () + "%";
