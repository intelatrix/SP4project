...
public class OnMouseHover : MonoBehaviour {
	...
	void OnMouseOver() {
		if (name == "dentist") {
			...
			content.GetComponent<Text> ().text = "Cost: SGD$" + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().costOfEvent [2].ToString ();
			content2.GetComponent<Text> ().text = "Pioneer Discount: " + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().eventDiscount [2].ToString () + "% off";
		} else if (name == "church") {
			title.GetComponent<Text> ().text = "Church";
			content.GetComponent<Text> ().text = "Cost: SGD$" + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().costOfEvent [3].ToString ();
			content2.GetComponent<Text> ().text = "Pioneer Discount: " + GameObject.Find ("elderly").GetComponent<ElderlySetting> ().eventDiscount [3].ToString () + "% off";
		}   else if (name == "Car") {
